...
function reactToAttributeChange (element: Element, attribute: string, onAttributeChange: Function, debounceWait = 75): void {
  const onAttributeChangeDebounced = debounce(onAttributeChange as any, debounceWait, { trailing: true })
...
function addPreview (activePreviewContainer: Element): void {
  ...
  iframeSandboxed.srcdoc = activePreviewContainer.textContent ?? ''
